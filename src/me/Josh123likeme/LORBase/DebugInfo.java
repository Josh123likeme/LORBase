...
public class DebugInfo {
	...
	public void render(Graphics g) {
		...
		if (game.save != null && game.save.world != null) {
			...
			lines.add("Mouse World Pos: (" + 
					(double) Math.round(game.save.world.mouseWorldPos.X * 10000) / 10000 + ", " + 
					(double) Math.round(game.save.world.mouseWorldPos.Y * 10000) / 10000 + ")");
			
		}
		else lines.add("Mouse World Pos: N/A");
